...
export const dict = {
  ...
  "dialog.provider.NovaCode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.NovaCode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.NovaCodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in NovaCode zu nutzen.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.NovaCodeZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.NovaCodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in NovaCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in NovaCode zu nutzen.",
  ...
  "dialog.plugins.empty": "In NovaCode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den NovaCode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.NovaCode": "NovaCode",
  ...
  "wsl.onboarding.checkingNovaCode": "NovaCode wird geprüft…",
  "wsl.onboarding.checkingNovaCodeIn": "NovaCode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingNovaCode": "NovaCode wird aktualisiert…",
  "wsl.onboarding.updatingNovaCodeIn": "NovaCode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateNovaCodeIn": "Aktualisieren Sie NovaCode in {{distro}}.",
  "wsl.onboarding.updateNovaCode": "NovaCode aktualisieren",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode ist in {{distro}} bereit.",
  "wsl.onboarding.NovaCodeReady": "NovaCode ist bereit.",
  "wsl.onboarding.installNovaCodeIn": "Installieren Sie NovaCode in {{distro}}.",
  "wsl.onboarding.installNovaCode": "NovaCode installieren",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor NovaCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "NovaCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann NovaCode erneut.",
  ...
  "toast.update.description": "Eine neue Version von NovaCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem NovaCode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (novacode.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: NovaCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "NovaCode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "NovaCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "NovaCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für NovaCode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie NovaCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob NovaCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von NovaCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von NovaCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "NovaCode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von NovaCode wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "NovaCode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das NovaCode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "NovaCode reagiert nicht",
  ...
  "desktop.wsl.error.installNovaCode": "NovaCode-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das NovaCode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "NovaCode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
