export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka NovaCode",
  ...
  "desktop.recovery.loadFailed": "NovaCode se nepodařilo načíst",
  "desktop.recovery.terminated": "NovaCode okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "NovaCode nereaguje",
  ...
  "desktop.wsl.error.installNovaCode": "NovaCode instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode není v této distribuci nainstalováno",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NovaCode aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.NovaCode.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.NovaCodeGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezplatné modely poskytované NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Návštěva ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v NovaCode.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v NovaCode.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému NovaCode serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingNovaCode": "Kontrola NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Kontrola NovaCode v {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Aktualizace NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Aktualizace NovaCode v {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Aktualizace NovaCode v {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Aktualizovat NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode je připraveno v {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode je připraven.",
  "wsl.onboarding.installNovaCodeIn": "Nainstalujte NovaCode do {{distro}}.",
  "wsl.onboarding.installNovaCode": "Instalovat NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než NovaCode může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "NovaCode nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze NovaCode ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu NovaCode",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (novacode.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: NovaCode zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server NovaCode uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro NovaCode",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled NovaCode na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude NovaCode následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma NovaCode.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění NovaCode",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi NovaCode.",
