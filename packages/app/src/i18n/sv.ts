export const dict = {
  ...
  "desktop.recovery.loadFailed": "NovaCode kunde inte läsas in",
  "desktop.recovery.terminated": "NovaCode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "NovaCode svarar inte",
  ...
  "desktop.wsl.error.installNovaCode": "Installationen av NovaCode misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode är inte installerat i den här distributionen",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode är installerat men kunde inte köras",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NovaCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.NovaCode.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.NovaCode.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.NovaCodeGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.NovaCodeZen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.NovaCodeZen.visit.prefix": "Besök ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i NovaCode.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i NovaCode.json",
  ...
  "dialog.server.description": "Växla vilken NovaCode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingNovaCode": "Kontrollerar NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Kontrollerar NovaCode i {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Uppdaterar NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Uppdaterar NovaCode i {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Uppdatera NovaCode i {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Uppdatera NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode är redo i {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode är redo.",
  "wsl.onboarding.installNovaCodeIn": "Installera NovaCode i {{distro}}.",
  "wsl.onboarding.installNovaCode": "Installera NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan NovaCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "NovaCode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan NovaCode igen.",
  ...
  "help.tabs.introduction": "NovaCode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av NovaCode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till NovaCode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (novacode.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, NovaCode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör NovaCode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för NovaCode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur NovaCode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om NovaCode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa NovaCodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när NovaCode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av NovaCode.",
