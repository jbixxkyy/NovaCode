export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "NovaCode მენიუ",
  ...
  "desktop.recovery.loadFailed": "NovaCode ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "NovaCode ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "NovaCode არ პასუხობს",
  ...
  "desktop.wsl.error.installNovaCode": "NovaCode ინსტალაცია ვერ მოხერხდა",
  "desktop.wsl.error.alreadyAdded": "{{distro}} უკვე დამატებულია",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode არ არის დაინსტალირებული ამ დისტროში",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode დაინსტალირებულია, მაგრამ ვერ გაშვება",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NovaCode განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "კურირებული მოდელები, მათ შორის Claude, GPT, Gemini და სხვა",
  "dialog.provider.NovaCode.tagline": "სანდო ოპტიმიზებული მოდელები",
  "dialog.provider.NovaCodeGo.tagline": "დაბალფასიანი გამოწერა ყველასთვის",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია NovaCode",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები NovaCode-ში.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen გაძლევთ წვდომას კოდირების აგენტებისთვის საიმედო ოპტიმიზირებული მოდელების კურირებულ კომპლექტზე.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "ეწვიეთ ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " თქვენი API გასაღების შესაგროვებლად.",
  "provider.connect.oauth.code.visit.prefix": "ეწვიეთ ",
  "provider.connect.oauth.code.visit.link": "ეს ბმული",
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები NovaCode-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები NovaCode-ში.",
  ...
  "dialog.plugins.empty": "პლაგინები კონფიგურირებულია NovaCode.json-ში",
  ...
  "dialog.server.description": "გადართეთ რომელ NovaCode სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingNovaCode": "შემოწმებულია NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "შემოწმებულია NovaCode-ში {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "განახლება NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "NovaCode განახლება ხდება {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "განახლება NovaCode {{distro}}-ში.",
  "wsl.onboarding.updateNovaCode": "განახლება NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode მზად არის {{distro}}-ში.",
  "wsl.onboarding.NovaCodeReady": "NovaCode მზად არის.",
  "wsl.onboarding.installNovaCodeIn": "დააინსტალირეთ NovaCode {{distro}}-ში.",
  "wsl.onboarding.installNovaCode": "დააინსტალირეთ NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ NovaCode შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "NovaCode ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode სამუშაო მაგიდა ახლა აგებულია ჩანართების გარშემო.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NovaCode-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა NovaCode გუნდს",
  ...
  "error.chain.checkConfig": "შეამოწმეთ თქვენი კონფიგურაცია (novacode.json) პროვაიდერის/მოდელების სახელები",
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, NovaCode ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "app.name.desktop": "NovaCode სამუშაო მაგიდა",
  ...
  "settings.desktop.wsl.description": "გაუშვით NovaCode სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა NovaCode",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება NovaCode თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა NovaCode სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის NovaCode თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც NovaCode გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ NovaCode-ის უახლეს ვერსიას.",
