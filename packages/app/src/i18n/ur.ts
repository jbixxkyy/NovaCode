export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode دستاویزات",
  ...
  "desktop.recovery.loadFailed": "NovaCode لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "NovaCode ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "NovaCode جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.NovaCodeNotInstalled": "{{distro}} میں NovaCode انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "NovaCode کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.NovaCode.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.NovaCode.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.NovaCodeGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "NovaCode کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور NovaCode میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور NovaCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور NovaCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "NovaCode.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس NovaCode سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingNovaCode": "NovaCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingNovaCodeIn": "{{distro}} میں NovaCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingNovaCode": "NovaCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingNovaCodeIn": "{{distro}} میں NovaCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateNovaCodeIn": "{{distro}} میں NovaCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateNovaCode": "NovaCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.NovaCodeReady": "NovaCode تیار ہے۔",
  "wsl.onboarding.installNovaCodeIn": "{{distro}} میں NovaCode انسٹال کریں۔",
  "wsl.onboarding.installNovaCode": "NovaCode انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ NovaCode WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "NovaCode اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر NovaCode کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "NovaCode Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NovaCode ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم NovaCode ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (novacode.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، NovaCode ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "NovaCode میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر NovaCode سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "NovaCode کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر NovaCode کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا NovaCode سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "NovaCode کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "NovaCode لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ NovaCode کا تازہ ترین ورژن چلا رہے ہیں۔",
