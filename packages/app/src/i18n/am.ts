export const dict = {
  ...
  "desktop.recovery.loadFailed": "NovaCode መጫን አልቻለም",
  "desktop.recovery.terminated": "NovaCode መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "NovaCode ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "NovaCode ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.NovaCode.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.NovaCodeGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በNovaCode",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በNovaCode ይጠቀሙ።",
  ...
  "provider.connect.NovaCodeZen.line1": "NovaCode ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.NovaCodeZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.NovaCodeZen.visit.prefix": "ጎብኝ ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  "provider.connect.oauth.code.visit.prefix": "ጎብኝ ",
  "provider.connect.oauth.code.visit.link": "ይህ ሊንክ",
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በNovaCode ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በNovaCode ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ NovaCode.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው NovaCode አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingNovaCode": "መፈተሽ NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "NovaCodeን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingNovaCode": "በማዘመን ላይ NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "በማዘመን ላይ NovaCode በ{{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "አዘምን NovaCode በ{{distro}}።",
  "wsl.onboarding.updateNovaCode": "አዘምን NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.NovaCodeReady": "NovaCode ዝግጁ ነው።",
  "wsl.onboarding.installNovaCodeIn": "መጫን NovaCode በ{{distro}} ውስጥ።",
  "wsl.onboarding.installNovaCode": "ጫን NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCodeአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) NovaCode WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "NovaCode በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ NovaCode።",
  ...
  "help.tabs.introduction": "NovaCode ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የNovaCode ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለNovaCode ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (novacode.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ NovaCode እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "NovaCode ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "NovaCode ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የNovaCode አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለNovaCode",
  ...
  "settings.general.row.appearance.description": "NovaCodeበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "NovaCode ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "NovaCode ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "NovaCode ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የNovaCode እትም እያሄዱ ነው።",
