export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "ไม่ได้ติดตั้ง NovaCode ในดิสโทรนี้",
  "desktop.wsl.error.opencodeCannotRun": "ติดตั้ง NovaCode แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.opencodeNotInstalled": "ไม่ได้ติดตั้ง NovaCode ใน {{distro}}",
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ NovaCode...",
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ NovaCode ใน {{distro}}...",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต NovaCode...",
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต NovaCode ใน {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "อัปเดต NovaCode ใน {{distro}}",
  "wsl.onboarding.updateOpencode": "อัปเดต NovaCode",
  "wsl.onboarding.opencodeReadyIn": "NovaCode พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.opencodeReady": "NovaCode พร้อมใช้งานแล้ว",
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง NovaCode ใน {{distro}}",
  "wsl.onboarding.installOpencode": "ติดตั้ง NovaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ยังไม่ได้ติดตั้ง NovaCode",
