export const dict = {
  ...
  "dialog.provider.NovaCode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.NovaCode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.NovaCodeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.NovaCodeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.NovaCodeZen.visit.prefix": "Besøg ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i NovaCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i NovaCode.json",
  ...
  "dialog.server.description": "Skift hvilken NovaCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingNovaCode": "Tjekker NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Tjekker NovaCode i {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Opdaterer NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Opdaterer NovaCode i {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Opdater NovaCode i {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Opdater NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før NovaCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "NovaCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter NovaCode igen.",
  ...
  "toast.update.description": "En ny version af NovaCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til NovaCode-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (novacode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, NovaCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør NovaCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for NovaCode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan NovaCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om NovaCode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas NovaCodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når NovaCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af NovaCode.",
  ...
  "desktop.recovery.loadFailed": "NovaCode kunne ikke indlæses",
  "desktop.recovery.terminated": "NovaCode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af NovaCode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "NovaCode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
