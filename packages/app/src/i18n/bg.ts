export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode Документация",
  ...
  "desktop.menu.ariaLabel": "NovaCode меню",
  ...
  "desktop.recovery.loadFailed": "NovaCode не успя да се зареди",
  "desktop.recovery.terminated": "Прозорецът NovaCode приключи неочаквано",
  "desktop.recovery.unresponsive": "NovaCode не отговаря",
  ...
  "desktop.wsl.error.installNovaCode": "Инсталирането на NovaCode е неуспешно",
  "desktop.wsl.error.alreadyAdded": "{{distro}} вече е добавен",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode не е инсталиран в тази дистрибуция",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode е инсталиран, но не може да стартира",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode не е инсталиран в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NovaCode актуализацията приключи, но {{distro}} все още съобщава {{installed}}; очаквано {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Подбрани модели, включително Claude, GPT, Gemini и други",
  "dialog.provider.NovaCode.tagline": "Надеждни оптимизирани модели",
  "dialog.provider.NovaCodeGo.tagline": "Абонамент на ниска цена за всеки",
  ...
  "dialog.model.unpaid.freeModels.title": "Безплатни модели, предоставени от NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Въведете своя {{provider}} API ключ, за да свържете акаунта си и да използвате {{provider}} модели в NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen ви дава достъп до подбран набор от надеждни оптимизирани модели за кодиращи агенти.",
  ...
  "provider.connect.NovaCodeZen.visit.suffix": "за да вземете своя ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Посетете",
  "provider.connect.oauth.code.visit.link": "тази връзка",
  "provider.connect.oauth.code.visit.suffix":
    "за да вземете вашия код за оторизация, за да свържете акаунта си и да използвате {{provider}} модели в NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и въведете кода по-долу, за да свържете акаунта си и да използвате {{provider}} модели в NovaCode.",
  ...
  "dialog.plugins.empty": "Добавки, конфигурирани в NovaCode.json",
  ...
  "dialog.server.description": "Превключете към кой NovaCode сървър се свързва това приложение.",
  ...
  "wsl.onboarding.checkingNovaCode": "Проверява се NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Проверява се NovaCode в {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Актуализиране на NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Актуализиране на NovaCode в {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Актуализирайте NovaCode в {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Актуализация NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode е готов в {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode е готов.",
  "wsl.onboarding.installNovaCodeIn": "Инсталирайте NovaCode в {{distro}}.",
  "wsl.onboarding.installNovaCode": "Инсталирайте NovaCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) се изисква, преди NovaCode да може да добави WSL сървър",
  "wsl.onboarding.wslUnavailable.title": "WSL не е наличен",
  "wsl.onboarding.wslUnavailable.description": "NovaCode не можа да провери WSL на тази машина.",
  "wsl.onboarding.installWsl": "Инсталирайте WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирайте Windows, за да завършите инсталирането на WSL, след което отворете отново NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop вече е изграден около раздели.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Вече е достъпна за инсталиране нова версия на NovaCode ({{version}}).",
  ...
  "error.page.report.prefix": "Моля, докладвайте тази грешка на екипа на NovaCode",
  ...
  "error.chain.checkConfig": "Проверете имената на доставчика/модела на вашата конфигурация (novacode.json).",
  "error.chain.mcpFailed":
    'MCP сървър "{{name}}" не успя. Имайте предвид, че NovaCode все още не поддържа MCP удостоверяване.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode включва безплатни модели, така че можете да започнете веднага.",
  ...
  "settings.desktop.wsl.description": "Стартирайте сървъра NovaCode вътре в WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете езика на дисплея за NovaCode",
  ...
  "settings.general.row.appearance.description": "Персонализирайте как изглежда NovaCode на вашето устройство",
  "settings.general.row.colorScheme.title": "Цветова схема",
  "settings.general.row.colorScheme.description": "Изберете дали NovaCode следва системната, светла или тъмна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Персонализирайте как е тематично NovaCode.",
  ...
  "settings.updates.row.startup.description": "Автоматично проверявайте за актуализации при стартиране на NovaCode",
  ...
  "settings.updates.toast.latest.description": "Вие използвате най-новата версия на NovaCode.",
