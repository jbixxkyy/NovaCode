export const dict = {
  ...
  "desktop.menu.documentation": "Documentație NovaCode",
  ...
  "desktop.menu.ariaLabel": "Meniu NovaCode",
  ...
  "desktop.recovery.loadFailed": "NovaCode nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra NovaCode s-a închis neașteptat",
  "desktop.recovery.unresponsive": "NovaCode nu răspunde",
  ...
  "desktop.wsl.error.installNovaCode": "Instalarea NovaCode a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode nu este instalat în această distribuție",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea NovaCode s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.NovaCode.tagline": "Modele optimizate, fiabile",
  "dialog.provider.NovaCodeGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.NovaCodeZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.NovaCodeZen.visit.prefix": "Vizitează",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în NovaCode.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în NovaCode.json",
  ...
  "dialog.server.description": "Schimbă serverul NovaCode la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingNovaCode": "Se verifică NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Se verifică NovaCode în {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Se actualizează NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Se actualizează NovaCode în {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Actualizează NovaCode în {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Actualizează NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode este gata în {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode este gata.",
  "wsl.onboarding.installNovaCodeIn": "Instalează NovaCode în {{distro}}.",
  "wsl.onboarding.installNovaCode": "Instalează NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca NovaCode să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "NovaCode nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune NovaCode ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei NovaCode",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (novacode.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, NovaCode nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul NovaCode în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru NovaCode",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul NovaCode pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă NovaCode urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema NovaCode.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea NovaCode",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune NovaCode.",
