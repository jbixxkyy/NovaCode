...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða NovaCode",
  "NovaCode-glugganum var óvænt lokað",
  "NovaCode svarar ekki",
  ...
  "Uppsetning NovaCode mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "NovaCode er ekki uppsett í þessari dreifingu",
  "NovaCode er uppsett en ekki var hægt að keyra það",
  "NovaCode er ekki uppsett í {{distro}}",
  "Uppfærslu NovaCode lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.NovaCode.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.NovaCode.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.NovaCodeGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.NovaCodeZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.NovaCodeZen.visit.prefix": "Heimsókn",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í NovaCode.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í NovaCode.json",
  ...
  "dialog.server.description": "Skiptu um hvaða NovaCode miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingNovaCode": "Athugar NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Athugar NovaCode í {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Uppfærir NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Uppfærir NovaCode í {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Uppfærðu NovaCode í {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Uppfærðu NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode er tilbúið í {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode er tilbúinn.",
  "wsl.onboarding.installNovaCodeIn": "Settu upp NovaCode í {{distro}}.",
  "wsl.onboarding.installNovaCode": "Settu upp NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en NovaCode getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "NovaCode gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan NovaCode aftur.",
  ...
  "help.tabs.introduction": "NovaCode Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af NovaCode ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til NovaCode teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (novacode.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, NovaCode styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "NovaCode inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "NovaCode skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu NovaCode netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir NovaCode",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig NovaCode lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort NovaCode fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig NovaCode er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar NovaCode ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af NovaCode.",
