export const dict = {
  ...
  "dialog.provider.NovaCode.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.NovaCode.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.NovaCodeGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.NovaCodeZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.NovaCodeZen.visit.prefix": "Visita ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in NovaCode.",
  ...
  "dialog.plugins.empty": "Plugin configurati in NovaCode.json",
  ...
  "dialog.server.description": "Cambia il server NovaCode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingNovaCode": "Controllo NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Controllo NovaCode in {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Aggiornamento NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Aggiornamento NovaCode in {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Aggiorna NovaCode in {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Aggiorna NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode è pronto in {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode è pronto.",
  "wsl.onboarding.installNovaCodeIn": "Installa NovaCode in {{distro}}.",
  "wsl.onboarding.installNovaCode": "Installa NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che NovaCode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "NovaCode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di NovaCode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team NovaCode",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (novacode.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: NovaCode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server NovaCode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per NovaCode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di NovaCode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se NovaCode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di NovaCode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di NovaCode",
  ...
  "settings.updates.toast.latest.title": "NovaCode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di NovaCode.",
  ...
  "desktop.menu.documentation": "Documentazione di NovaCode",
  ...
  "desktop.menu.ariaLabel": "Menu NovaCode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare NovaCode",
  "desktop.recovery.terminated": "La finestra di NovaCode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "NovaCode non risponde",
  ...
  "desktop.wsl.error.installNovaCode": "Installazione di NovaCode non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode non è installato in questa distribuzione",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di NovaCode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
