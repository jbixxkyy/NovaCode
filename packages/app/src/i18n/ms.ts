export const dict = {
  ...
  "desktop.recovery.loadFailed": "NovaCode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap NovaCode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "NovaCode tidak memberi respons",
  ...
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini NovaCode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.NovaCode.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.NovaCodeGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Layari",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam NovaCode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam NovaCode.json",
  ...
  "dialog.server.description": "Tukar pelayan NovaCode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingNovaCode": "Sedang menyemak NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Sedang menyemak NovaCode dalam {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Sedang mengemas kini NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Sedang mengemas kini NovaCode dalam {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Kemas kini NovaCode dalam {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Kemas kini NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode sedia digunakan.",
  "wsl.onboarding.installNovaCodeIn": "Pasang NovaCode dalam {{distro}}.",
  "wsl.onboarding.installNovaCode": "Pasang NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum NovaCode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "NovaCode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu NovaCode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan NovaCode",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (novacode.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, NovaCode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan NovaCode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk NovaCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa NovaCode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada NovaCode mengikut sistem, tema cerah, atau gelap",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila NovaCode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini NovaCode.",
