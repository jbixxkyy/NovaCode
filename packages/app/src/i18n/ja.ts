export const dict = {
  ...
  "desktop.recovery.loadFailed": "NovaCodeを読み込めませんでした",
  "desktop.recovery.terminated": "NovaCodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "NovaCodeが応答していません",
  ...
  "desktop.wsl.error.installNovaCode": "NovaCodeのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.NovaCodeMissing": "このディストリビューションにはNovaCodeがインストールされていません",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.NovaCodeNotInstalled": "{{distro}}にはNovaCodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "NovaCodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.NovaCode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.NovaCode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.NovaCodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "NovaCodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、NovaCodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.NovaCodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.NovaCodeZen.visit.prefix": " ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してNovaCodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、NovaCodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "NovaCode.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するNovaCodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingNovaCode": "NovaCodeを確認中...",
  "wsl.onboarding.checkingNovaCodeIn": "{{distro}}内のNovaCodeを確認中...",
  "wsl.onboarding.updatingNovaCode": "NovaCodeを更新中...",
  "wsl.onboarding.updatingNovaCodeIn": "{{distro}}内のNovaCodeを更新中...",
  "wsl.onboarding.updateNovaCodeIn": "{{distro}}内のNovaCodeを更新してください。",
  "wsl.onboarding.updateNovaCode": "NovaCodeを更新",
  "wsl.onboarding.NovaCodeReadyIn": "{{distro}}内のNovaCodeの準備ができました。",
  "wsl.onboarding.NovaCodeReady": "NovaCodeの準備ができました。",
  "wsl.onboarding.installNovaCodeIn": "{{distro}}にNovaCodeをインストールしてください。",
  "wsl.onboarding.installNovaCode": "NovaCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NovaCodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、NovaCodeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "NovaCode Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NovaCodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをNovaCodeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (novacode.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: NovaCodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "NovaCodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でNovaCodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "NovaCodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのNovaCodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "NovaCodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "NovaCodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "NovaCode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "NovaCode は最新バージョンです。",
