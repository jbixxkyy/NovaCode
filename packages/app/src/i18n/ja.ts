export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "NovaCodeのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.opencodeMissing": "このディストリビューションにはNovaCodeがインストールされていません",
  "desktop.wsl.error.opencodeCannotRun": "NovaCodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはNovaCodeがインストールされていません",
  ...
  "wsl.onboarding.checkingOpencode": "NovaCodeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のNovaCodeを確認中...",
  "wsl.onboarding.updatingOpencode": "NovaCodeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のNovaCodeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のNovaCodeを更新してください。",
  "wsl.onboarding.updateOpencode": "NovaCodeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のNovaCodeの準備ができました。",
  "wsl.onboarding.opencodeReady": "NovaCodeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にNovaCodeをインストールしてください。",
  "wsl.onboarding.installOpencode": "NovaCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovaCodeがインストールされていません",
