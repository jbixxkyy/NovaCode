export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode دیاں دستاویزاں",
  ...
  "desktop.menu.ariaLabel": "NovaCode مینو",
  ...
  "desktop.recovery.loadFailed": "NovaCode لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "NovaCode دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "NovaCode جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installNovaCode": "NovaCode دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.NovaCodeMissing": "اس ڈسٹرو وچ NovaCode انسٹال نئیں اے",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.NovaCodeNotInstalled": "{{distro}} وچ NovaCode انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "NovaCode دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.NovaCode.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.NovaCode.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.NovaCodeGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "NovaCode دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے NovaCode وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "ویکھو ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے NovaCode وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے NovaCode وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "NovaCode.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس NovaCode سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingNovaCode": "NovaCode چیک کر رئے آں...",
  "wsl.onboarding.checkingNovaCodeIn": "{{distro}} چ NovaCode دی جانچ پڑتال...",
  "wsl.onboarding.updatingNovaCode": "NovaCode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingNovaCodeIn": "{{distro}} وچ NovaCode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateNovaCodeIn": "{{distro}} وچ NovaCode نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateNovaCode": "NovaCode اپ ڈیٹ کرو",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode {{distro}} چ تیار اے۔",
  "wsl.onboarding.NovaCodeReady": "NovaCode تیار اے۔",
  "wsl.onboarding.installNovaCodeIn": "{{distro}} وچ NovaCode انسٹال کرو۔",
  "wsl.onboarding.installNovaCode": "NovaCode انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NovaCode دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "NovaCode ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر NovaCode دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "NovaCode Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NovaCode ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع NovaCode ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (novacode.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، NovaCode ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "NovaCode چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "app.name.desktop": "NovaCode ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر NovaCode سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "NovaCode لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے NovaCode کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا NovaCode سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "NovaCode نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں NovaCode لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی NovaCode دا تازہ ترین ورژن چلا رئے او۔",
