export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "NovaCode دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.opencodeMissing": "اس ڈسٹرو وچ NovaCode انسٹال نئیں اے",
  "desktop.wsl.error.opencodeCannotRun": "NovaCode انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} وچ NovaCode انسٹال نئیں اے",
  ...
  "wsl.onboarding.checkingOpencode": "NovaCode چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ NovaCode دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "NovaCode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ NovaCode نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ NovaCode نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "NovaCode اپ ڈیٹ کرو",
  "wsl.onboarding.opencodeReadyIn": "NovaCode {{distro}} چ تیار اے۔",
  "wsl.onboarding.opencodeReady": "NovaCode تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ NovaCode انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "NovaCode انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovaCode انسٹال نئیں کیتا گیا",
