export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode Ҳуҷҷатҳо",
  ...
  "desktop.recovery.loadFailed": "NovaCode бор карда натавонист",
  "desktop.recovery.terminated": "NovaCode тиреза ба таври ғайричашмдошт қатъ карда шуд",
  "desktop.recovery.unresponsive": "NovaCode ҷавоб намедиҳад",
  ...
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode дар {{distro}} насб нашудааст",
  "desktop.wsl.error.updateVersion":
    "NovaCode навсозӣ анҷом ёфт, аммо {{distro}} то ҳол гузориш медиҳад {{installed}}; интизорӣ {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Моделҳои интихобшуда, аз ҷумла Claude, GPT, Gemini ва ғайра",
  "dialog.provider.NovaCode.tagline": "Моделҳои боэътимоди оптимизатсияшуда",
  "dialog.provider.NovaCodeGo.tagline": "Обунаи арзон барои ҳама",
  ...
  "dialog.model.unpaid.freeModels.title": "Моделҳои ройгон аз ҷониби NovaCode пешниҳодшуда",
  ...
  "provider.connect.apiKey.description":
    "Барои пайваст кардани ҳисоби худ калиди {{provider}} API-ро ворид кунед ва моделҳои {{provider}}-ро дар NovaCode истифода баред.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen ба шумо дастрасӣ ба маҷмӯи мураттабшудаи моделҳои боэътимоди оптимизатсияшуда барои агентҳои рамзгузориро медиҳад.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Ташриф",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": "барои гирифтани калиди API худ.",
  "provider.connect.oauth.code.visit.prefix": "Ташриф",
  "provider.connect.oauth.code.visit.link": "ин пайванд",
  "provider.connect.oauth.code.visit.suffix":
    "Барои ҷамъ овардани рамзи иҷозати шумо барои пайваст кардани ҳисоби шумо ва истифода бурдани моделҳои {{provider}} дар NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ва рамзи зерро ворид кунед, то ҳисоби худро пайваст кунед ва моделҳои {{provider}}-ро дар NovaCode истифода баред.",
  ...
  "dialog.plugins.empty": "Плагинҳо дар NovaCode.json танзим карда шудаанд",
  ...
  "dialog.server.description": "Гузариш кунед, ки ин барнома ба кадом сервери NovaCode пайваст мешавад.",
  ...
  "wsl.onboarding.checkingNovaCode": "Санҷиш NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Санҷиш NovaCode дар {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Навсозӣ NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Навсозии NovaCode дар {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Навсозии NovaCode дар {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Навсозӣ NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode дар {{distro}} тайёр аст.",
  "wsl.onboarding.NovaCodeReady": "NovaCode тайёр аст.",
  "wsl.onboarding.installNovaCodeIn": "NovaCode дар {{distro}} насб кунед.",
  "wsl.onboarding.installNovaCode": "Насб кунед NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode насб нашудааст",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) лозим аст, то NovaCode сервери WSL илова карда шавад",
  "wsl.onboarding.wslUnavailable.title": "WSL дастрас нест",
  "wsl.onboarding.wslUnavailable.description": "NovaCode WSL-ро дар ин мошин тафтиш карда натавонист.",
  "wsl.onboarding.installWsl": "Насб кунед WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Барои анҷом додани насби WSL Windows-ро аз нав оғоз кунед, сипас NovaCode-ро боз кунед.",
  ...
  "help.tabs.introduction": "NovaCode Desktop ҳоло дар атрофи ҷадвалҳо сохта шудааст.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Версияи нави NovaCode ({{version}}) ҳоло барои насб дастрас аст.",
  ...
  "error.page.report.prefix": "Лутфан дар бораи ин хато ба дастаи NovaCode хабар диҳед",
  ...
  "error.chain.checkConfig": "Номҳои провайдери конфигуратсияи худро (novacode.json) санҷед",
  "error.chain.mcpFailed":
    'MCP сервери "{{name}}" ноком шуд. Дар хотир доред, ки NovaCode тасдиқи MCP-ро ҳанӯз дастгирӣ намекунад.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode моделҳои ройгонро дар бар мегирад, то шумо метавонед фавран оғоз кунед.",
  ...
  "settings.desktop.wsl.description": "Сервери NovaCode-ро дар WSL дар Windows иҷро кунед.",
  ...
  "settings.general.row.language.description": "Забони намоишро барои NovaCode иваз кунед",
  ...
  "settings.general.row.appearance.description":
    "Фармоиш диҳед, ки чӣ гуна NovaCode дар дастгоҳи шумо намуди зоҳирӣ дорад",
  "settings.general.row.colorScheme.title": "Схемаи ранг",
  "settings.general.row.colorScheme.description":
    "Интихоб кунед, ки NovaCode аз рӯи система, равшанӣ ё мавзӯи торик пайравӣ мекунад",
  "settings.general.row.theme.title": "Мавзӯъ",
  "settings.general.row.theme.description": "Чӣ тавр NovaCode мавзӯъро танзим кунед.",
  ...
  "settings.updates.row.startup.description": "Ҳангоми оғоз кардани NovaCode навсозиҳо ба таври худкор санҷед",
  ...
  "settings.updates.toast.latest.description": "Шумо версияи охирини NovaCode-ро иҷро карда истодаед.",
