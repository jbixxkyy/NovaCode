export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode Документација",
  ...
  "desktop.menu.ariaLabel": "NovaCode мени",
  ...
  "desktop.recovery.loadFailed": "NovaCode не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот NovaCode неочекувано заврши",
  "desktop.recovery.unresponsive": "NovaCode не реагира",
  ...
  "desktop.wsl.error.installNovaCode": "инсталацијата NovaCode не успеа",
  "desktop.wsl.error.alreadyAdded": "{{distro}} е веќе додаден",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode не е инсталиран во оваа дистрибуција",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode е инсталиран, но не може да се изврши",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NovaCode ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Курирани модели вклучувајќи Claude, GPT, Gemini и повеќе",
  "dialog.provider.NovaCode.tagline": "Сигурни оптимизирани модели",
  "dialog.provider.NovaCodeGo.tagline": "Ниска цена претплата за секого",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатни модели обезбедени од NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen ви дава пристап до куриран сет на сигурни оптимизирани модели за агенти за кодирање.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Посетете",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": "да го соберете вашиот клуч API.",
  "provider.connect.oauth.code.visit.prefix": "Посетете",
  "provider.connect.oauth.code.visit.link": "оваа врска",
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во NovaCode.",
  ...
  "dialog.plugins.empty": "Приклучоци конфигурирани во NovaCode.json",
  ...
  "dialog.server.description": "Променете на кој NovaCode сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingNovaCode": "Се проверува NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Се проверува NovaCode во {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Се ажурира NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Се ажурира NovaCode во {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Ажурирајте NovaCode во {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Ажурирај NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode е подготвен во {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode е подготвен.",
  "wsl.onboarding.installNovaCodeIn": "Инсталирајте NovaCode во {{distro}}.",
  "wsl.onboarding.installNovaCode": "Инсталирај NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред NovaCode да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "NovaCode не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop сега е изграден околу картичките.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новата верзија на NovaCode ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот NovaCode",
  ...
  "error.chain.checkConfig": "Проверете ги имињата на давателот/моделот за конфигурација (novacode.json).",
  "error.chain.mcpFailed":
    "MCP серверот „{{name}}“ не успеа. Забелешка, NovaCode сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "NovaCode вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот NovaCode во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за NovaCode",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа NovaCode на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали NovaCode ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како NovaCode е тематизирана.",
  ...
  "settings.updates.row.startup.description": "Автоматски проверувајте дали има ажурирања кога ќе се стартува NovaCode",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на NovaCode.",
