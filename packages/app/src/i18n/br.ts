export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do NovaCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.opencodeMissing": "O NovaCode não está instalado nesta distribuição",
  "desktop.wsl.error.opencodeCannotRun": "O NovaCode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.opencodeNotInstalled": "O NovaCode não está instalado em {{distro}}",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o NovaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o NovaCode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o NovaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o NovaCode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o NovaCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o NovaCode",
  "wsl.onboarding.opencodeReadyIn": "O NovaCode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O NovaCode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o NovaCode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o NovaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovaCode não instalado",
