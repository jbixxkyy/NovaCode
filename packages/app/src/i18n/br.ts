export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do NovaCode",
  ...
  "desktop.menu.ariaLabel": "Menu do NovaCode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o NovaCode",
  "desktop.recovery.terminated": "A janela do NovaCode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O NovaCode não está respondendo",
  ...
  "desktop.wsl.error.installNovaCode": "Falha na instalação do NovaCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.NovaCodeMissing": "O NovaCode não está instalado nesta distribuição",
  "desktop.wsl.error.NovaCodeCannotRun": "O NovaCode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.NovaCodeNotInstalled": "O NovaCode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do NovaCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.NovaCode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.NovaCodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Visite ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no NovaCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em NovaCode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor NovaCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingNovaCode": "Verificando o NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Verificando o NovaCode em {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Atualizando o NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Atualizando o NovaCode em {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Atualize o NovaCode em {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Atualizar o NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "O NovaCode está pronto em {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "O NovaCode está pronto.",
  "wsl.onboarding.installNovaCodeIn": "Instale o NovaCode em {{distro}}.",
  "wsl.onboarding.installNovaCode": "Instalar o NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o NovaCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O NovaCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o NovaCode novamente.",
  ...
  "help.tabs.introduction": "Agora, o NovaCode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do NovaCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do NovaCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (novacode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: NovaCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor NovaCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do NovaCode",
  ...
  "settings.general.row.appearance.description": "Personalize como o NovaCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o NovaCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o NovaCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o NovaCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do NovaCode.",
