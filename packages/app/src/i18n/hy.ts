export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "NovaCode մենյու",
  ...
  "desktop.recovery.loadFailed": "NovaCode չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "NovaCode պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "NovaCode-ը չի արձագանքում",
  ...
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NovaCode թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.NovaCode.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.NovaCodeGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և NovaCode-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Այցելություն ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և NovaCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և NovaCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են NovaCode.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ NovaCode սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingNovaCode": "Ստուգում է NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Ստուգում է NovaCode-ը {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Թարմացվում է NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Թարմացվում է NovaCode-ը {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Թարմացնել NovaCode-ը {{distro}}-ում։",
  "wsl.onboarding.updateNovaCode": "Թարմացնել NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.NovaCodeReady": "NovaCode պատրաստ է։",
  "wsl.onboarding.installNovaCodeIn": "Տեղադրեք NovaCode-ը {{distro}}-ում։",
  "wsl.onboarding.installNovaCode": "Տեղադրեք NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի NovaCode-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "NovaCode-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք NovaCode։",
  ...
  "help.tabs.introduction": "NovaCode Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NovaCode-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին NovaCode թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (novacode.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ NovaCode-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "NovaCode ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք NovaCode սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն NovaCode",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է NovaCode տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ NovaCode-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է NovaCode-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ NovaCode-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք NovaCode-ի վերջին տարբերակը։",
