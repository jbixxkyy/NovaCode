export const dict = {
  ...
  "desktop.menu.documentation": "Документация NovaCode",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить NovaCode",
  "desktop.recovery.terminated": "Окно NovaCode неожиданно завершило работу",
  "desktop.recovery.unresponsive": "NovaCode не отвечает",
  ...
  "desktop.wsl.error.installNovaCode": "Не удалось установить NovaCode",
  "desktop.wsl.error.alreadyAdded": "Дистрибутив {{distro}} уже добавлен",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode не установлен в этом дистрибутиве",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode установлен, но его не удалось запустить",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление NovaCode завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.NovaCode.tagline": "Надёжные оптимизированные модели",
  "dialog.provider.NovaCodeGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Посетите ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": ", чтобы получить ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в NovaCode.",
  ...
  "dialog.plugins.empty": "Плагины настроены в NovaCode.json",
  ...
  "dialog.server.description": "Выберите сервер NovaCode, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingNovaCode": "Проверка NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Проверка NovaCode в {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Обновление NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Обновление NovaCode в {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Обновите NovaCode в {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Обновить NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode в {{distro}} готов к работе.",
  "wsl.onboarding.NovaCodeReady": "NovaCode готов к работе.",
  "wsl.onboarding.installNovaCodeIn": "Установите NovaCode в {{distro}}.",
  "wsl.onboarding.installNovaCode": "Установить NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в NovaCode требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "NovaCode не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте NovaCode.",
  ...
  "help.tabs.introduction": "Теперь работа в NovaCode Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия NovaCode ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде NovaCode",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера и модели в конфигурации (novacode.json)",
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: NovaCode пока не поддерживает MCP-авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер NovaCode внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения NovaCode",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид NovaCode на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли NovaCode системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление NovaCode.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске NovaCode",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию NovaCode.",
