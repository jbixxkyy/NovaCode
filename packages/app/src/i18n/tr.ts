...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "NovaCode yüklenemedi",
  "desktop.recovery.terminated": "NovaCode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "NovaCode yanıt vermiyor",
  ...
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "NovaCode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.NovaCode.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.NovaCodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "NovaCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve NovaCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.NovaCodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak NovaCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak NovaCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler NovaCode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi NovaCode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingNovaCode": "NovaCode kontrol ediliyor...",
  "wsl.onboarding.checkingNovaCodeIn": "{{distro}} içinde NovaCode kontrol ediliyor...",
  "wsl.onboarding.updatingNovaCode": "NovaCode güncelleniyor...",
  "wsl.onboarding.updatingNovaCodeIn": "{{distro}} içinde NovaCode güncelleniyor...",
  "wsl.onboarding.updateNovaCodeIn": "{{distro}} içindeki NovaCode'u güncelleyin.",
  "wsl.onboarding.updateNovaCode": "NovaCode'u güncelle",
  "wsl.onboarding.NovaCodeReadyIn": "{{distro}} içinde NovaCode hazır.",
  "wsl.onboarding.NovaCodeReady": "NovaCode hazır.",
  "wsl.onboarding.installNovaCodeIn": "NovaCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installNovaCode": "NovaCode'u kur",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NovaCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "NovaCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından NovaCode'u tekrar açın.",
  ...
  "help.tabs.introduction": "NovaCode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NovaCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı NovaCode ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (novacode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: NovaCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "NovaCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "NovaCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "NovaCode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "NovaCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "NovaCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "NovaCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "NovaCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "NovaCode'un en son sürümünü kullanıyorsunuz.",
