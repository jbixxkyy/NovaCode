...
const desktop = [
  ...
  "Kilépés",
  "Az NovaCode betöltése sikertelen",
  "Az NovaCode ablaka váratlanul leállt",
  "Az NovaCode nem válaszol",
  ...
  "Az NovaCode telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az NovaCode nincs telepítve ebben a disztribúcióban",
  "Az NovaCode telepítve van, de nem futtatható",
  "Az NovaCode nincs telepítve ebben: {{distro}}",
  "Az NovaCode frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.NovaCode.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.NovaCode.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.NovaCodeGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A NovaCode ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a NovaCode-ben.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "A NovaCode Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Látogatás",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a NovaCode-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a NovaCode-ben.",
  ...
  "dialog.plugins.empty": "Az NovaCode.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik NovaCode szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingNovaCode": "NovaCode ellenőrzése...",
  "wsl.onboarding.checkingNovaCodeIn": "NovaCode ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingNovaCode": "NovaCode frissítése...",
  "wsl.onboarding.updatingNovaCodeIn": "NovaCode frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateNovaCodeIn": "Frissítse a NovaCode-t a {{distro}}-ben.",
  "wsl.onboarding.updateNovaCode": "Frissítse a NovaCode-t",
  "wsl.onboarding.NovaCodeReadyIn": "A NovaCode készen áll a {{distro}}-ben.",
  "wsl.onboarding.NovaCodeReady": "A NovaCode készen áll.",
  "wsl.onboarding.installNovaCodeIn": "Telepítse a NovaCode-t a {{distro}}-be.",
  "wsl.onboarding.installNovaCode": "Telepítse a NovaCode-t",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "A NovaCode nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a NovaCode hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A NovaCode nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a NovaCode programot.",
  ...
  "help.tabs.introduction": "A NovaCode Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A NovaCode ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a NovaCode csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (novacode.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a NovaCode még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A NovaCode ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "NovaCode asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a NovaCode szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a NovaCode kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a NovaCode az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a NovaCode a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a NovaCode témáját.",
  ...
  "settings.updates.row.startup.description": "A NovaCode indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a NovaCode legújabb verzióját futtatja.",
