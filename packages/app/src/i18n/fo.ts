export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode Skjøl",
  ...
  "desktop.menu.ariaLabel": "NovaCode valmynd",
  ...
  "desktop.recovery.loadFailed": "NovaCode miseydnaðist at heinta",
  "desktop.recovery.terminated": "NovaCode vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "NovaCode svarar ikki",
  ...
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NovaCode dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.NovaCode.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.NovaCode.tagline": "Álítandi optimerað modell",
  "dialog.provider.NovaCodeGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.NovaCodeZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.NovaCodeZen.visit.prefix": "Vitja ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í NovaCode.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í NovaCode.json",
  ...
  "dialog.server.description": "Skift hvønn NovaCode ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingNovaCode": "Kanna NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Kanna NovaCode í {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Dagføring NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Dagføring NovaCode í {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Dagfør NovaCode í {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Dagfør NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode er klárt í {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode er klárt.",
  "wsl.onboarding.installNovaCodeIn": "Set NovaCode upp í {{distro}}.",
  "wsl.onboarding.installNovaCode": "Set upp NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn NovaCode kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "NovaCode kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani NovaCode aftur.",
  ...
  "help.tabs.introduction": "NovaCode Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av NovaCode ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til NovaCode toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (novacode.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, NovaCode stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "NovaCode Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr NovaCode ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri NovaCode",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu NovaCode sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um NovaCode fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu NovaCode er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá NovaCode byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av NovaCode.",
