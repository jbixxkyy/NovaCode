export const dict = {
  ...
  "dialog.provider.NovaCode.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.NovaCode.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.NovaCodeGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "NovaCoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja NovaCodessa.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Avaa ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja NovaCodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja NovaCodessa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään NovaCode.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda NovaCode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingNovaCode": "Tarkistetaan NovaCodea...",
  "wsl.onboarding.checkingNovaCodeIn": "Tarkistetaan NovaCodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Päivitetään NovaCodea...",
  "wsl.onboarding.updatingNovaCodeIn": "Päivitetään NovaCodea kohteessa {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Päivitä NovaCode jakelussa {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Päivitä NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode on valmis.",
  "wsl.onboarding.installNovaCodeIn": "Asenna NovaCode jakeluun {{distro}}.",
  "wsl.onboarding.installNovaCode": "Asenna NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin NovaCode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "NovaCode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten NovaCode uudelleen.",
  ...
  "toast.update.description": "NovaCoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä NovaCode-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (novacode.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että NovaCode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita NovaCode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda NovaCoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä NovaCode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö NovaCode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta NovaCoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun NovaCode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät NovaCoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "NovaCode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "NovaCode-valikko",
  ...
  "desktop.recovery.loadFailed": "NovaCoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "NovaCode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "NovaCode ei vastaa",
  ...
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NovaCoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "NovaCode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
