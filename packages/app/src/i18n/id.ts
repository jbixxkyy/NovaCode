export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi NovaCode",
  ...
  "desktop.recovery.loadFailed": "NovaCode gagal dimuat",
  "desktop.recovery.terminated": "Jendela NovaCode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "NovaCode tidak merespons",
  ...
  "desktop.wsl.error.installNovaCode": "Instalasi NovaCode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode belum terinstal di distro ini",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan NovaCode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.NovaCode.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.NovaCodeGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Kunjungi ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " untuk mendapatkan kunci API Anda.",
  "provider.connect.oauth.code.visit.prefix": "Kunjungi ",
  "provider.connect.oauth.code.visit.link": "tautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di NovaCode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di NovaCode.json",
  ...
  "dialog.server.description": "Ganti server NovaCode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingNovaCode": "Memeriksa NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Memeriksa NovaCode di {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Memperbarui NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Memperbarui NovaCode di {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Perbarui NovaCode di {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Perbarui NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode siap di {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode siap.",
  "wsl.onboarding.installNovaCodeIn": "Instal NovaCode di {{distro}}.",
  "wsl.onboarding.installNovaCode": "Instal NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum NovaCode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "NovaCode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru NovaCode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim NovaCode",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (novacode.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: NovaCode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server NovaCode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk NovaCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan NovaCode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah NovaCode mengikuti tema sistem, terang, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema NovaCode.",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat NovaCode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru NovaCode.",
