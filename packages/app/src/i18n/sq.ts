export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni NovaCode",
  ...
  "desktop.menu.ariaLabel": "Menuja NovaCode",
  ...
  "desktop.recovery.loadFailed": "NovaCode nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja NovaCode u mbyll papritur",
  "desktop.recovery.unresponsive": "NovaCode nuk po përgjigjet",
  ...
  "desktop.wsl.error.NovaCodeMissing": "NovaCode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i NovaCode përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.NovaCode.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.NovaCodeGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Vizitoni ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në NovaCode.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në NovaCode.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server NovaCode lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingNovaCode": "Po kontrollon NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Po kontrollon NovaCode në {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "NovaCode po përditësohet...",
  "wsl.onboarding.updatingNovaCodeIn": "Po përditëson NovaCode në {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Përditëso NovaCode në {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Përditëso NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode është gati në {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode është gati.",
  "wsl.onboarding.installNovaCodeIn": "Instaloni NovaCode në {{distro}}.",
  "wsl.onboarding.installNovaCode": "Instaloni NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se NovaCode të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "NovaCode nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i NovaCode ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i NovaCode",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (novacode.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, NovaCode nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin NovaCode brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për NovaCode",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket NovaCode në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse NovaCode ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e NovaCode.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset NovaCode",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të NovaCode.",
