...
export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "NovaCode-meny",
  ...
  "desktop.recovery.loadFailed": "NovaCode kunne ikke lastes inn",
  "desktop.recovery.terminated": "NovaCode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "NovaCode svarer ikke",
  ...
  "desktop.wsl.error.installNovaCode": "Installasjonen av NovaCode mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode er ikke installert i denne distribusjonen",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode er installert, men kunne ikke kjøres",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av NovaCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.NovaCode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.NovaCodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Besøk ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i NovaCode.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i NovaCode.json",
  ...
  "dialog.server.description": "Bytt hvilken NovaCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av NovaCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til NovaCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (novacode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at NovaCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør NovaCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for NovaCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan NovaCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om NovaCode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i NovaCode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når NovaCode starter",
  ...
  "settings.updates.toast.latest.title": "NovaCode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av NovaCode.",
  ...
  "wsl.onboarding.checkingNovaCode": "Sjekker NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Sjekker NovaCode i {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Oppdaterer NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Oppdaterer NovaCode i {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Oppdater NovaCode i {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Oppdater NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode er klar i {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode er klar.",
  "wsl.onboarding.installNovaCodeIn": "Installer NovaCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før NovaCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "NovaCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter NovaCode på nytt.",
  ...
  "help.tabs.introduction": "NovaCode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
