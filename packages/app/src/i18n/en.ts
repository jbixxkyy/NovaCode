...
export const dict = {
  ...
  "command.project.relocate": "Relocate folder",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in NovaCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "NovaCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "novacode.ai/zen",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in NovaCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in novacode.json",
  ...
  "dialog.server.description": "Switch which NovaCode server this app connects to.",
  ...
  "dialog.server.desktop": "Desktop App",
  "dialog.server.desktop.description": "Share sessions with the desktop app on this machine",
  "dialog.server.desktop.connect": "Connect",
  "dialog.server.desktop.disconnect": "Disconnect",
  "dialog.server.desktop.connected": "Connected",
  "dialog.server.desktop.unavailable": "Desktop app not running",
  "dialog.server.desktop.switchToDesktop": "Switch to desktop",
  "dialog.server.desktop.switchToWeb": "Switch to web",
  "dialog.server.desktop.activeHint": "Desktop sessions are now active. Switch back to web to use the browser's own server.",
  "dialog.server.desktop.webActiveHint": "Web sessions are active. Switch to desktop to share the desktop server.",
  "dialog.server.desktop.shareTitle": "Share with web app",
  "dialog.server.desktop.shareDescription": "Allow the browser web app on this machine to discover and connect to this desktop’s sessions",
  "dialog.server.desktop.shareOnHint": "Sharing is on — open the web app at http://localhost:4444 or your LAN IP (e.g. http://192.168.1.25:4444) and it will show Connected.",
  "dialog.server.desktop.shareOffHint": "Sharing is off — the web app will show “Desktop app not running”.",
  ...
  "wsl.onboarding.step.opencode": "NovaCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking NovaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking NovaCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating NovaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating NovaCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update NovaCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update NovaCode",
  "wsl.onboarding.opencodeReadyIn": "NovaCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "NovaCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install NovaCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install NovaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovaCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before NovaCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "NovaCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "dialog.project.relocate.title": "Choose the new project folder",
  ...
  "toast.update.description": "A new version of NovaCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the NovaCode team",
  ...
  "error.chain.checkConfig": "Check your config (novacode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, NovaCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "NovaCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the NovaCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for NovaCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how NovaCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether NovaCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how NovaCode is themed.",
  ...
  "settings.general.row.wordmarkFont.title": "Wordmark Font",
  "settings.general.row.wordmarkFont.description": "Font used for the NovaCode logo watermark",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when NovaCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of NovaCode.",
  ...
  "settings.skills.description": "Manage skills available to agents in this workspace.",
  "settings.skills.search.placeholder": "Search skills",
  "settings.skills.empty": "No skills found",
  "settings.skills.empty.search": "No skills match your search",
  "settings.skills.empty.description":
    "Skills are markdown files in .opencode/skills, .claude/skills, or .agents/skills. Add a SKILL.md to create one.",
  "settings.skills.loadError": "Failed to load skills",
  "settings.skills.tag.slash": "Slash command",
  "settings.skills.add": "Add skill",
  "settings.skills.delete": "Delete",
  "settings.skills.delete.confirm.title": "Delete skill",
  "settings.skills.delete.confirm.description": 'Delete skill "{{name}}"? This will remove {{path}}.',
  "settings.skills.delete.toast.success.title": "Skill deleted",
  "settings.skills.delete.toast.success.description": '"{{name}}" was removed.',
  "settings.skills.delete.toast.failed.title": "Failed to delete skill",
  "settings.skills.create.title": "Create skill",
  "settings.skills.create.name.label": "Name",
  "settings.skills.create.name.placeholder": "my-skill",
  "settings.skills.create.name.description": "Lowercase, hyphens, no spaces or path separators",
  "settings.skills.create.description.label": "Description",
  "settings.skills.create.description.placeholder": "What this skill does and when to use it",
  "settings.skills.create.content.label": "Content",
  "settings.skills.create.content.placeholder": "Skill instructions in markdown…",
  "settings.skills.create.toast.success.title": "Skill created",
  "settings.skills.create.toast.success.description": '"{{name}}" was created.',
  "settings.skills.create.toast.failed.title": "Failed to create skill",
  "settings.skills.create.error.name.required": "Name is required",
  "settings.skills.create.error.name.format": "Use lowercase letters, numbers, hyphens",
  "settings.skills.create.error.name.exists": "A skill with this name already exists",
  "settings.skills.create.error.content.required": "Content is required",
  ...
  "session.memory.title": "Memory Solar System",
  "session.memory.subtitle": "Click the main view to explore memories",
  "session.memory.open": "Open memories",
  "session.memory.detailFallback": "Memory detail",
  "session.memory.hint": "Hover a planet to see its beam · Click to inspect · Center is your active session",
  "session.memory.hintShort": "Hover to highlight · Click to inspect",
  "session.memory.speed": "Speed",
  "session.memory.pause": "Pause",
  "session.memory.play": "Play",
}
