export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "NovaCode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno NovaCode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "NovaCode se ne odziva",
  ...
  "desktop.wsl.error.installNovaCode": "Namestitev NovaCode ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode ni nameščen v tej distribuciji",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev NovaCode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.NovaCode.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.NovaCodeGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Obisk ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v NovaCode.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v NovaCode.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom NovaCode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingNovaCode": "Preverjanje NovaCode ...",
  "wsl.onboarding.checkingNovaCodeIn": "Preverjanje NovaCode v {{distro}} ...",
  "wsl.onboarding.updatingNovaCode": "Posodabljanje NovaCode ...",
  "wsl.onboarding.updatingNovaCodeIn": "Posodabljanje NovaCode v {{distro}} ...",
  "wsl.onboarding.updateNovaCodeIn": "Posodobite NovaCode v {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Posodobite NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode je pripravljen v {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode je pripravljen.",
  "wsl.onboarding.installNovaCodeIn": "Namestite NovaCode v {{distro}}.",
  "wsl.onboarding.installNovaCode": "Namestite NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko NovaCode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "NovaCode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica NovaCode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi NovaCode",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (novacode.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, NovaCode še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik NovaCode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za NovaCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako NovaCode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali NovaCode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo NovaCode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene NovaCode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico NovaCode.",
