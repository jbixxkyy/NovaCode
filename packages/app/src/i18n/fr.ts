export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'NovaCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.opencodeMissing": "NovaCode n'est pas installé dans cette distribution",
  "desktop.wsl.error.opencodeCannotRun": "NovaCode est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.opencodeNotInstalled": "NovaCode n'est pas installé dans {{distro}}",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'NovaCode...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'NovaCode dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'NovaCode...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'NovaCode dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour NovaCode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour NovaCode",
  "wsl.onboarding.opencodeReadyIn": "NovaCode est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "NovaCode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez NovaCode dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer NovaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovaCode non installé",
