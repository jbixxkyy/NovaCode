export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'NovaCode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'NovaCode",
  "desktop.recovery.terminated": "La fenêtre NovaCode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "NovaCode ne répond pas",
  ...
  "desktop.wsl.error.installNovaCode": "Échec de l'installation d'NovaCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode n'est pas installé dans cette distribution",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'NovaCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.NovaCode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.NovaCodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Visitez ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans NovaCode.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans NovaCode.json",
  ...
  "dialog.server.description": "Changez le serveur NovaCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingNovaCode": "Vérification d'NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Vérification d'NovaCode dans {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Mise à jour d'NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Mise à jour d'NovaCode dans {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Mettez à jour NovaCode dans {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Mettre à jour NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode est prêt dans {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode est prêt.",
  "wsl.onboarding.installNovaCodeIn": "Installez NovaCode dans {{distro}}.",
  "wsl.onboarding.installNovaCode": "Installer NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'NovaCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "NovaCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'NovaCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe NovaCode",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (novacode.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'NovaCode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "NovaCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur NovaCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour NovaCode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'NovaCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si NovaCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'NovaCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'NovaCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'NovaCode.",
