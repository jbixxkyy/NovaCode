export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "NovaCode quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.opencodeMissing": "Bu distribütivdə NovaCode quraşdırılmayıb",
  "desktop.wsl.error.opencodeCannotRun": "NovaCode quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.opencodeNotInstalled": "NovaCode {{distro}} distribütivində quraşdırılmayıb",
  ...
  "wsl.onboarding.checkingOpencode": "NovaCode yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də NovaCode yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "NovaCode yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də NovaCode yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də NovaCode-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "NovaCode-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "NovaCode {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "NovaCode hazırdır.",
  "wsl.onboarding.installOpencodeIn": "NovaCode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "NovaCode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovaCode quraşdırılmayıb",
