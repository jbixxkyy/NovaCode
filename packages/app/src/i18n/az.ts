export const dict = {
  ...
  "desktop.recovery.loadFailed": "NovaCode yüklənə bilmədi",
  "desktop.recovery.terminated": "NovaCode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "NovaCode cavab vermir",
  ...
  "desktop.wsl.error.installNovaCode": "NovaCode quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.NovaCodeMissing": "Bu distribütivdə NovaCode quraşdırılmayıb",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "NovaCode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.NovaCode.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.NovaCodeGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "NovaCode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və NovaCode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və NovaCode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və NovaCode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər NovaCode.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu NovaCode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingNovaCode": "NovaCode yoxlanılır...",
  "wsl.onboarding.checkingNovaCodeIn": "{{distro}}-də NovaCode yoxlanılır...",
  "wsl.onboarding.updatingNovaCode": "NovaCode yenilənir...",
  "wsl.onboarding.updatingNovaCodeIn": "{{distro}}-də NovaCode yenilənir...",
  "wsl.onboarding.updateNovaCodeIn": "{{distro}}-də NovaCode-u yeniləyin.",
  "wsl.onboarding.updateNovaCode": "NovaCode-u yeniləyin",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode {{distro}}-də hazırdır.",
  "wsl.onboarding.NovaCodeReady": "NovaCode hazırdır.",
  "wsl.onboarding.installNovaCodeIn": "NovaCode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installNovaCode": "NovaCode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NovaCode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "NovaCode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra NovaCode-u yenidən açın.",
  ...
  "help.tabs.introduction": "NovaCode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NovaCode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı NovaCode komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (novacode.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: NovaCode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində NovaCode serverini işlət.",
  ...
  "settings.general.row.language.description": "NovaCode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "NovaCode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "NovaCode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "NovaCode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "NovaCode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "NovaCode-un ən son versiyasından istifadə edirsiniz.",
