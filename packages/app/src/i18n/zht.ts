...
export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "此發行版中未安裝 NovaCode",
  "desktop.wsl.error.opencodeCannotRun": "已安裝 NovaCode，但無法執行",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 NovaCode",
  ...
  "provider.connect.opencodeZen.line1": "NovaCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 NovaCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 NovaCode...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 NovaCode 已就緒。",
  "wsl.onboarding.opencodeReady": "NovaCode 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 NovaCode。",
  "wsl.onboarding.installOpencode": "安裝 NovaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 NovaCode",
