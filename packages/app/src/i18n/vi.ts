export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu NovaCode",
  ...
  "desktop.recovery.loadFailed": "Không tải được NovaCode",
  "desktop.recovery.terminated": "Cửa sổ NovaCode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "NovaCode không phản hồi",
  ...
  "desktop.wsl.error.installNovaCode": "Không cài đặt được NovaCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật NovaCode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.NovaCode.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.NovaCodeGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do NovaCode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Truy cập ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong NovaCode.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong NovaCode.json",
  ...
  "dialog.server.description": "Chuyển máy chủ NovaCode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingNovaCode": "Đang kiểm tra NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Đang kiểm tra NovaCode trong {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Đang cập nhật NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Đang cập nhật NovaCode trong {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Cập nhật NovaCode trong {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Cập nhật NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode đã sẵn sàng.",
  "wsl.onboarding.installNovaCodeIn": "Cài đặt NovaCode trong {{distro}}.",
  "wsl.onboarding.installNovaCode": "Cài đặt NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi NovaCode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "NovaCode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của NovaCode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm NovaCode",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (novacode.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: NovaCode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ NovaCode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho NovaCode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của NovaCode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem NovaCode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của NovaCode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi NovaCode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của NovaCode.",
