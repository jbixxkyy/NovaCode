...
export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "NovaCode 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.opencodeMissing": "此发行版中未安装 NovaCode",
  "desktop.wsl.error.opencodeCannotRun": "已安装 NovaCode，但无法运行",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 NovaCode",
  ...
  "provider.connect.opencodeZen.line1": "NovaCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 NovaCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 NovaCode...",
  "wsl.onboarding.updatingOpencode": "正在更新 NovaCode...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 NovaCode...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 NovaCode。",
  "wsl.onboarding.updateOpencode": "更新 NovaCode",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 NovaCode 已就绪。",
  "wsl.onboarding.opencodeReady": "NovaCode 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 NovaCode。",
  "wsl.onboarding.installOpencode": "安装 NovaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 NovaCode",
