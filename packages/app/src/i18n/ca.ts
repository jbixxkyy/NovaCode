export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode Documentació",
  ...
  "desktop.menu.ariaLabel": "menú NovaCode.",
  ...
  "desktop.recovery.loadFailed": "NovaCode no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra NovaCode s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "NovaCode no respon",
  ...
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NovaCode actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.NovaCode.tagline": "Models optimitzats fiables",
  "dialog.provider.NovaCodeGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.NovaCodeZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a NovaCode.",
  ...
  "dialog.plugins.empty": "Connectors configurats a NovaCode.json",
  ...
  "dialog.server.description": "Canvia a quin NovaCode servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingNovaCode": "S'està comprovant NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "S'està registrant NovaCode a {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "S'està actualitzant NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "S'està actualitzant NovaCode a {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Actualitza NovaCode a {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Actualització NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode està llest a {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode està llest.",
  "wsl.onboarding.installNovaCodeIn": "Instal·leu NovaCode a {{distro}}.",
  "wsl.onboarding.installNovaCode": "Instal·la NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que NovaCode pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "NovaCode no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de NovaCode ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip NovaCode.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (novacode.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que NovaCode encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "NovaCode Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor NovaCode dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a NovaCode",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu NovaCode al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si NovaCode segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de NovaCode.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï NovaCode.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de NovaCode.",
