...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "NovaCode įkelti nepavyko",
  "NovaCode langas netikėtai užsidarė",
  "NovaCode neatsako",
  ...
  "NovaCode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "NovaCode šiame distributyve neįdiegtas",
  "NovaCode įdiegtas, bet jo paleisti nepavyko",
  "NovaCode neįdiegtas distributyve {{distro}}",
  "NovaCode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.NovaCode.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.NovaCode.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.NovaCodeGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami NovaCode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.NovaCodeZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.NovaCodeZen.visit.prefix": "Aplankykite",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius NovaCode.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti NovaCode.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio NovaCode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingNovaCode": "Tikrinama NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Tikrinama NovaCode {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Atnaujinamas NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Atnaujinamas NovaCode {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Atnaujinkite NovaCode {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Atnaujinkite NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode yra paruoštas {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode yra paruoštas.",
  "wsl.onboarding.installNovaCodeIn": "Įdiekite NovaCode į {{distro}}.",
  "wsl.onboarding.installNovaCode": "Įdiekite NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad NovaCode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "NovaCode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują NovaCode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą NovaCode komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (novacode.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad NovaCode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "NovaCode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "NovaCode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite NovaCode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite NovaCode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip NovaCode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar NovaCode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite NovaCode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas NovaCode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią NovaCode versiją.",
