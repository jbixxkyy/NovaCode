export const dict = {
  ...
  "desktop.menu.documentation": "Документація NovaCode",
  ...
  "desktop.menu.ariaLabel": "Меню NovaCode",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити NovaCode",
  "desktop.recovery.terminated": "Роботу вікна NovaCode несподівано завершено",
  "desktop.recovery.unresponsive": "NovaCode не відповідає",
  ...
  "desktop.wsl.error.installNovaCode": "Не вдалося встановити NovaCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode встановлено, але його не вдалося запустити",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення NovaCode завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.NovaCode.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.NovaCodeGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Відвідайте ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у NovaCode.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в NovaCode.json",
  ...
  "dialog.server.description": "Перемкніть сервер NovaCode, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingNovaCode": "Перевірка NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Перевірка NovaCode у {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Оновлення NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Оновлення NovaCode у {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Оновіть NovaCode у {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Оновити NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode готовий до роботи у {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode готовий до роботи.",
  "wsl.onboarding.installNovaCodeIn": "Встановіть NovaCode у {{distro}}.",
  "wsl.onboarding.installNovaCode": "Встановити NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в NovaCode потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "NovaCode не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія NovaCode ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді NovaCode",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (novacode.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, NovaCode ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер NovaCode всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу NovaCode",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд NovaCode на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи NovaCode використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему NovaCode.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску NovaCode",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію NovaCode.",
