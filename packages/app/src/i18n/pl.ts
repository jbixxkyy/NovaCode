export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja NovaCode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać NovaCode",
  "desktop.recovery.terminated": "Okno NovaCode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "NovaCode nie odpowiada",
  ...
  "desktop.wsl.error.installNovaCode": "Nie udało się zainstalować NovaCode",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.NovaCodeMissing": "Program NovaCode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.NovaCodeCannotRun": "Program NovaCode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja NovaCode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.NovaCode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.NovaCodeGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w NovaCode.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku NovaCode.json",
  ...
  "dialog.server.description": "Przełącz serwer NovaCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingNovaCode": "Sprawdzanie NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Sprawdzanie NovaCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Aktualizowanie NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Aktualizowanie NovaCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Zaktualizuj NovaCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Zaktualizuj NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode jest gotowy.",
  "wsl.onboarding.installNovaCodeIn": "Zainstaluj NovaCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installNovaCode": "Zainstaluj NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim NovaCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "NovaCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja NovaCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu NovaCode",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (novacode.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: NovaCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "NovaCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer NovaCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla NovaCode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd NovaCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy NovaCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw NovaCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania NovaCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji NovaCode.",
