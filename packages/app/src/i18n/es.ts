export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de NovaCode",
  ...
  "desktop.menu.ariaLabel": "Menú de NovaCode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar NovaCode",
  "desktop.recovery.terminated": "La ventana de NovaCode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "NovaCode no responde",
  ...
  "desktop.wsl.error.installNovaCode": "No se pudo instalar NovaCode",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode no está instalado en esta distribución",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de NovaCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.NovaCode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.NovaCodeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.NovaCodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en NovaCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en NovaCode.json",
  ...
  "dialog.server.description": "Cambiar el servidor de NovaCode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingNovaCode": "Comprobando NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Comprobando NovaCode en {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Actualizando NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Actualizando NovaCode en {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Actualiza NovaCode en {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Actualizar NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode está listo en {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode está listo.",
  "wsl.onboarding.installNovaCodeIn": "Instala NovaCode en {{distro}}.",
  "wsl.onboarding.installNovaCode": "Instalar NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que NovaCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "NovaCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de NovaCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de NovaCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (novacode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: NovaCode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor NovaCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para NovaCode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve NovaCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si NovaCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de NovaCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia NovaCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de NovaCode.",
