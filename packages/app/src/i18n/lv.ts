export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode dokumentācija",
  ...
  "desktop.menu.ariaLabel": "NovaCode izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt NovaCode",
  "desktop.recovery.terminated": "NovaCode logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "NovaCode neatbild",
  ...
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NovaCode atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.NovaCode.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.NovaCodeGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Apmeklējiet",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus NovaCode.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti NovaCode.json",
  ...
  "dialog.server.description": "Mainiet, pie kura NovaCode servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingNovaCode": "Pārbaudu NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Pārbaudu NovaCode distribūcijā {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Atjauninu NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Atjauninu NovaCode distribūcijā {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Atjauniniet NovaCode distribūcijā {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Atjauniniet NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode ir gatavs.",
  "wsl.onboarding.installNovaCodeIn": "Instalējiet NovaCode distribūcijā {{distro}}.",
  "wsl.onboarding.installNovaCode": "Instalējiet NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms NovaCode var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "NovaCode neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet NovaCode no jauna.",
  ...
  "help.tabs.introduction": "NovaCode Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna NovaCode versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu NovaCode komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (novacode.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, NovaCode vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "NovaCode darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist NovaCode serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt NovaCode saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā NovaCode izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai NovaCode sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet NovaCode tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot NovaCode",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko NovaCode versiju.",
