export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za NovaCode",
  ...
  "desktop.menu.ariaLabel": "NovaCode meni",
  ...
  "desktop.recovery.loadFailed": "NovaCode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor NovaCode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "NovaCode ne reaguje",
  ...
  "desktop.wsl.error.installNovaCode": "Instalacija NovaCode-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje NovaCode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.NovaCode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.NovaCodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u NovaCode-u.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Posjeti ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u NovaCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u NovaCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u NovaCode.json",
  ...
  "dialog.server.description": "Promijeni na koji se NovaCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingNovaCode": "Provjera NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "Provjera NovaCode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Ažuriranje NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Ažuriranje NovaCode u distribuciji {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Ažuriraj NovaCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Ažuriraj NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode je spreman.",
  "wsl.onboarding.installNovaCodeIn": "Instaliraj NovaCode u distribuciji {{distro}}.",
  "wsl.onboarding.installNovaCode": "Instaliraj NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi NovaCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "NovaCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija NovaCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku NovaCode timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (novacode.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: NovaCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni NovaCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u NovaCode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako NovaCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li NovaCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu NovaCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se NovaCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju NovaCode-a.",
