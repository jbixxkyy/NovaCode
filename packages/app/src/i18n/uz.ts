export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode hujjatlari",
  ...
  "desktop.menu.ariaLabel": "NovaCode menyusi",
  ...
  "desktop.recovery.loadFailed": "NovaCode yuklanmadi",
  "desktop.recovery.terminated": "NovaCode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "NovaCode javob bermayapti",
  ...
  "desktop.wsl.error.NovaCodeMissing": "NovaCode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "NovaCode yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.NovaCode.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.NovaCodeGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "NovaCode tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va NovaCode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va NovaCode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va NovaCode da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "NovaCode.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi NovaCode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingNovaCode": "NovaCode tekshirilmoqda...",
  "wsl.onboarding.checkingNovaCodeIn": "NovaCode {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingNovaCode": "NovaCode yangilanmoqda...",
  "wsl.onboarding.updatingNovaCodeIn": "NovaCode {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateNovaCodeIn": "NovaCode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateNovaCode": "NovaCode-ni yangilang",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode {{distro}} da tayyor.",
  "wsl.onboarding.NovaCodeReady": "NovaCode tayyor.",
  "wsl.onboarding.installNovaCodeIn": "NovaCode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installNovaCode": "NovaCode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NovaCode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "NovaCode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra NovaCode-ni qayta oching.",
  ...
  "help.tabs.introduction": "NovaCode Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "NovaCode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida NovaCode jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (novacode.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, NovaCode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "NovaCode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi NovaCode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "NovaCode uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "NovaCode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "NovaCode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "NovaCode mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "NovaCode ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz NovaCode oxirgi versiyasini ishga tushiryapsiz.",
