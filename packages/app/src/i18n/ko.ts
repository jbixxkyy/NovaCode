export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "NovaCode 확인 중...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 NovaCode 확인 중...",
  "wsl.onboarding.updatingOpencode": "NovaCode 업데이트 중...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 NovaCode 업데이트 중...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 NovaCode를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "NovaCode 업데이트",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 NovaCode를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opencodeReady": "NovaCode가 준비되었습니다.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 NovaCode를 설치하세요.",
  "wsl.onboarding.installOpencode": "NovaCode 설치",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovaCode가 설치되지 않음",
  ...
  "desktop.wsl.error.opencodeMissing": "이 배포판에 NovaCode가 설치되어 있지 않습니다",
  "desktop.wsl.error.opencodeCannotRun": "NovaCode가 설치되어 있지만 실행할 수 없습니다",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}에 NovaCode가 설치되어 있지 않습니다",
