...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "NovaCode se nije uspio učitati",
  "Prozor aplikacije NovaCode neočekivano je zatvoren",
  "NovaCode ne reagira",
  ...
  "Instalacija aplikacije NovaCode nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "NovaCode nije instaliran u ovoj distribuciji",
  "NovaCode je instaliran, ali se ne može pokrenuti",
  "NovaCode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije NovaCode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.NovaCode.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.NovaCode.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.NovaCodeGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Posjetiti",
  "provider.connect.NovaCodeZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u NovaCode.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u NovaCode.json",
  ...
  "dialog.server.description": "Promijenite na koji se NovaCode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingNovaCodeIn": "Provjera NovaCode u {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "Ažuriranje NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "Ažuriranje NovaCode u {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Ažurirajte NovaCode u {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Ažurirajte NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode je spreman u {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode je spreman.",
  "wsl.onboarding.installNovaCodeIn": "Instalirajte NovaCode u {{distro}}.",
  "wsl.onboarding.installNovaCode": "Instalirajte NovaCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što NovaCode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "NovaCode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite NovaCode.",
  ...
  "help.tabs.introduction": "Radna površina NovaCode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija NovaCode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku NovaCode timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (novacode.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, NovaCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "NovaCode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite NovaCode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za NovaCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako NovaCode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li NovaCode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je NovaCode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se NovaCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju NovaCode.",
