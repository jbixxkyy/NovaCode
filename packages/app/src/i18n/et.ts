export const dict = {
  ...
  "desktop.recovery.loadFailed": "NovaCode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "NovaCode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "NovaCode ei vasta",
  ...
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "NovaCode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.NovaCode.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.NovaCodeGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid NovaCode'is.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Külastage ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises NovaCode.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis NovaCode.json",
  ...
  "dialog.server.description": "Lülitage, millise NovaCode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingNovaCode": "NovaCode kontrollimine...",
  "wsl.onboarding.checkingNovaCodeIn": "NovaCode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "NovaCode värskendamine...",
  "wsl.onboarding.updatingNovaCodeIn": "NovaCode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Värskenda NovaCode jaotises {{distro}}.",
  "wsl.onboarding.updateNovaCode": "Värskenda NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode on valmis {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode on valmis.",
  "wsl.onboarding.installNovaCodeIn": "Installige NovaCode asukohta {{distro}}.",
  "wsl.onboarding.installNovaCode": "Installige NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui NovaCode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "NovaCode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti NovaCode.",
  ...
  "help.tabs.introduction": "NovaCode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse NovaCode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast NovaCode meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (novacode.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, NovaCode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "NovaCode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage NovaCode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke NovaCode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas NovaCode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas NovaCode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas NovaCode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui NovaCode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse NovaCode uusimat versiooni.",
