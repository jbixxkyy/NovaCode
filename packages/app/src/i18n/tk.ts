export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode Resminamalar",
  ...
  "desktop.menu.ariaLabel": "NovaCode menýusy",
  ...
  "desktop.recovery.loadFailed": "NovaCode ýükläp bilmedi",
  "desktop.recovery.terminated": "NovaCode penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "NovaCode jogap berenok",
  ...
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "NovaCode täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.NovaCode.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.NovaCodeGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "NovaCode tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we NovaCode-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "Sapar ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini NovaCode-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini NovaCode-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "NovaCode.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy NovaCode serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingNovaCode": "NovaCode barlamak ...",
  "wsl.onboarding.checkingNovaCodeIn": "{{distro}} içinde NovaCode barlanýar...",
  "wsl.onboarding.updatingNovaCode": "NovaCode täzelenmek ...",
  "wsl.onboarding.updatingNovaCodeIn": "{{distro}}-de NovaCode täzelenmek ...",
  "wsl.onboarding.updateNovaCodeIn": "NovaCode-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateNovaCode": "NovaCode täzeläň",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode {{distro}}-de taýýar.",
  "wsl.onboarding.NovaCodeReady": "NovaCode taýýar.",
  "wsl.onboarding.installNovaCodeIn": "{{distro}}-de NovaCode guruň.",
  "wsl.onboarding.installNovaCode": "NovaCode guruň",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) NovaCode WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "NovaCode bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra NovaCode açyň.",
  ...
  "help.tabs.introduction": "NovaCode Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin NovaCode ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy NovaCode toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (novacode.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, NovaCode entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "NovaCode serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "NovaCode üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "NovaCode enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "NovaCode ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "NovaCode-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "NovaCode işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "NovaCode-iň iň soňky wersiýasyny işleýärsiňiz.",
