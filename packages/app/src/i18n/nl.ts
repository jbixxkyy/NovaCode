export const dict = {
  ...
  "desktop.menu.documentation": "NovaCode-documentatie",
  ...
  "desktop.recovery.loadFailed": "NovaCode kan niet worden geladen",
  "desktop.recovery.terminated": "Het NovaCode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "NovaCode reageert niet",
  ...
  "desktop.wsl.error.installNovaCode": "Installatie van NovaCode is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De NovaCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.NovaCode.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.NovaCodeGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door NovaCode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in NovaCode te gebruiken.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "NovaCode Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.NovaCodeZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.NovaCodeZen.visit.prefix": "Ga naar ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in NovaCode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in NovaCode te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in NovaCode.json",
  ...
  "dialog.server.description": "Wijzig met welke NovaCode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingNovaCode": "NovaCode controleren...",
  "wsl.onboarding.checkingNovaCodeIn": "NovaCode controleren in {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "NovaCode bijwerken...",
  "wsl.onboarding.updatingNovaCodeIn": "NovaCode bijwerken in {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "Werk NovaCode bij in {{distro}}.",
  "wsl.onboarding.updateNovaCode": "NovaCode bijwerken",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode is gereed in {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode is klaar.",
  "wsl.onboarding.installNovaCodeIn": "Installeer NovaCode in {{distro}}.",
  "wsl.onboarding.installNovaCode": "Installeer NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat NovaCode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "NovaCode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens NovaCode opnieuw.",
  ...
  "help.tabs.introduction": "NovaCode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van NovaCode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het NovaCode-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (novacode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: NovaCode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "NovaCode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de NovaCode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor NovaCode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe NovaCode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of NovaCode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van NovaCode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer NovaCode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "NovaCode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van NovaCode.",
