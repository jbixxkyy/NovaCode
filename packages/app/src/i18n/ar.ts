export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل NovaCode",
  "desktop.recovery.terminated": "توقفت نافذة NovaCode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "NovaCode لا يستجيب",
  ...
  "desktop.wsl.error.installNovaCode": "فشل تثبيت NovaCode",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.NovaCodeMissing": "NovaCode غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.NovaCodeCannotRun": "NovaCode مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.NovaCodeNotInstalled": "NovaCode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث NovaCode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.NovaCode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.NovaCode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.NovaCodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من NovaCode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في NovaCode.",
  ...
  "provider.connect.NovaCodeZen.line1":
    "يمنحك NovaCode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.NovaCodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.NovaCodeZen.visit.link": "NovaCode.ai/zen",
  "provider.connect.NovaCodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في NovaCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في NovaCode.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في NovaCode.json",
  ...
  "dialog.server.description": "تبديل خادم NovaCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingNovaCode": "جارٍ التحقق من NovaCode...",
  "wsl.onboarding.checkingNovaCodeIn": "جارٍ التحقق من NovaCode في {{distro}}...",
  "wsl.onboarding.updatingNovaCode": "جارٍ تحديث NovaCode...",
  "wsl.onboarding.updatingNovaCodeIn": "جارٍ تحديث NovaCode في {{distro}}...",
  "wsl.onboarding.updateNovaCodeIn": "حدّث NovaCode في {{distro}}.",
  "wsl.onboarding.updateNovaCode": "تحديث NovaCode",
  "wsl.onboarding.NovaCodeReadyIn": "NovaCode جاهز في {{distro}}.",
  "wsl.onboarding.NovaCodeReady": "NovaCode جاهز.",
  "wsl.onboarding.installNovaCodeIn": "ثبّت NovaCode في {{distro}}.",
  "wsl.onboarding.installNovaCode": "تثبيت NovaCode",
  ...
  "wsl.onboarding.distroStatus.NovaCodeMissing": "NovaCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن NovaCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على NovaCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح NovaCode.",
  ...
  "help.tabs.introduction": "أصبح NovaCode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من NovaCode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق NovaCode",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (novacode.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن NovaCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن NovaCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم NovaCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ NovaCode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور NovaCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان NovaCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة NovaCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل NovaCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من NovaCode.",
