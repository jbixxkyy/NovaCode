export const dict = {
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت NovaCode",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.opencodeMissing": "NovaCode غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.opencodeCannotRun": "NovaCode مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.opencodeNotInstalled": "NovaCode غير مثبت في {{distro}}",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من NovaCode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من NovaCode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث NovaCode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث NovaCode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث NovaCode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث NovaCode",
  "wsl.onboarding.opencodeReadyIn": "NovaCode جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "NovaCode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت NovaCode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت NovaCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovaCode غير مثبت",
