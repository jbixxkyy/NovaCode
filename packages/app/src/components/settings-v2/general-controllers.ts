...
export function createAppearanceSettingsController() {
  ...
  return {
    ...
    fonts: {
      ...
      wordmark: createMemo(() => ({
        value: wordmarkInput(settings.appearance.wordmarkFont()),
        family: wordmarkFontFamily(settings.appearance.wordmarkFont()),
        placeholder: wordmarkDefault,
      })),
      ...
      setWordmark: (value: string) => settings.appearance.setWordmarkFont(value),
    },
  }
}
