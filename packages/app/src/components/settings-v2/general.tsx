...
const fontSettings = {
  ...
  wordmark: {
    action: "settings-wordmark-font",
    title: "settings.general.row.wordmarkFont.title",
    description: "settings.general.row.wordmarkFont.description",
    font: "wordmark",
    input: "setWordmark",
  },
} as const
  ...
  return (
    <div class="settings-v2-section">
      ...
      <SettingsListV2>
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <ExternalLink class="settings-v2-link" href="https://novacode.ai/docs/themes/">
        ...
        <FontSetting kind="wordmark" fonts={props.controller.fonts} />
      </SettingsListV2>
    </div>
  )
}
...
const FontSetting: Component<{
  kind: "ui" | "code" | "terminal" | "wordmark"
