export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon NovaCode ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "NovaCodening {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'NovaCode' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
