export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van NovaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van NovaCode is gedownload. Wil je deze installeren en NovaCode opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'NovaCode' te gebruiken.",
