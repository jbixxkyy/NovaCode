export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на NovaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от NovaCode е изтеглена. Искате ли да я инсталирате и рестартирате?",
  ...
  "desktop.cli.installed.message":
    "CLI инсталиран на {{path}}\n\nРестартирайте терминала си, за да използвате командата 'NovaCode'.",
