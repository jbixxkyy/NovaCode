export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የNovaCode ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከNovaCode ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
