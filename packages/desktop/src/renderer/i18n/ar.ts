export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من NovaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "تم تنزيل الإصدار {{version}} من NovaCode. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",
