export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse NovaCode uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "NovaCode'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „NovaCode” kasutamiseks taaskäivitage terminal.",
