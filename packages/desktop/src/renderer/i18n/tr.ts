export const dict = {
  ...
  "desktop.updater.none.message": "NovaCode'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "NovaCode'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'NovaCode' komutunu kullanmak için terminalinizi yeniden başlatın.",
