export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi NovaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace NovaCode. Chcete ji nainstalovat a aplikaci znovu spustit?",
  ...
  "desktop.cli.installed.message":
    "CLI nainstalováno do {{path}}\n\nRestartujte svůj terminál, abyste mohli použít příkaz 'NovaCode'.",
