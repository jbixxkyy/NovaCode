export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo NovaCoden uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "NovaCoden versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää NovaCoden uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'NovaCode'-komentoa.",
