export const dict = {
  ...
  "desktop.updater.none.message": "NovaCode-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "NovaCode-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'NovaCode' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
