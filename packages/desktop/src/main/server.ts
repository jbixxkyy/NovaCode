...
const SIDECAR_SERVICE_NAME = "novacode server"
...
export function preferAppEnv(userDataPath: string) {
  ...
  Object.assign(process.env, {
    ...shellEnv,
    NOVACODE_EXPERIMENTAL_ICON_DISCOVERY: "true",
    NOVACODE_EXPERIMENTAL_FILEWATCHER: "true",
    NOVACODE_CLIENT: "desktop",
...
export async function checkHealth(url: string, password?: string | null): Promise<boolean> {
  ...
  if (password) {
    const auth = Buffer.from(`novacode:${password}`).toString("base64")
