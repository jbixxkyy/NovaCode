...
const desktopStateNames = ["ai.novacode.desktop.dev", "ai.novacode.desktop.beta", "ai.novacode.desktop"]
...
function executableName() {
  return process.platform === "win32" ? "novacode-cli.exe" : "novacode-cli"
}
