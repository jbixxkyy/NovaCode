...
const releaseId = process.env.NOVACODE_RELEASE
if (!releaseId) throw new Error("NOVACODE_RELEASE is required")

const version = process.env.NOVACODE_VERSION
...
const macxTarGz = "novacode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "novacode-desktop-mac-arm64.app.tar.gz"
