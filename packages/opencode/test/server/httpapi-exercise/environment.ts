...
export const exerciseConfigDirectory = path.join(exerciseGlobalRoot, "config", "novacode")
export const exerciseDataDirectory = path.join(exerciseGlobalRoot, "data", "novacode")
