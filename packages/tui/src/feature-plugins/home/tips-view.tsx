...
const TIPS: Tip[] = [
  ...
  "Place TUI settings in {highlight}~/.config/novacode/tui.json{/highlight} for global config",
  ...
  "Create a plugin to prevent NovaCode from reading sensitive files",
  "Use {highlight}novacode run{/highlight} for non-interactive scripting",
  "Use {highlight}novacode --continue{/highlight} to resume the last session",
  "Use {highlight}novacode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}novacode serve{/highlight} for headless API access to NovaCode",
  "Use {highlight}novacode run --attach{/highlight} to connect to a running server",
  "Run {highlight}novacode upgrade{/highlight} to update to the latest version",
  "Run {highlight}novacode auth list{/highlight} to see all configured providers",
  "Run {highlight}novacode agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}novacode github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}novacode debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with NovaCode Zen for curated, tested models",
